...
public class ManageEmployees extends JFrame {
    ...
    public ManageEmployees() {
        ...
        deleteButton.addActionListener(e -> {
            ...
            if (idText.isEmpty() || idText.equals("Enter ID to Delete")) {
                JOptionPane.showMessageDialog(this, "Please enter an Employee ID to delete.", "Validation Error", JOptionPane.ERROR_MESSAGE);
                return;
            }
            try {
                ...
                JOptionPane.showMessageDialog(this, "Employee ID must be a valid number.", "Validation Error", JOptionPane.ERROR_MESSAGE);
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this, "Error: " + ex.getMessage());
            }
        });
    ...
    private void loadEmployeeData() {
        try (Connection conn = DriverManager.getConnection(DB_URL, DB_USERNAME, DB_PASSWORD);
             ...
             ResultSet rs = stmt.executeQuery("SELECT employee_id, full_name, department, email, username FROM Employees")) {
